...
#define PLNS_PER_LUN (1) // @jy: nvmevirt does not support multiplane TODO (actual: 4)
...
#define PCIE_BANDWIDTH (20100ull) //MB/s

#define NAND_4KB_READ_LATENCY_LSB (4000) //ns
#define NAND_4KB_READ_LATENCY_MSB (4000) //ns
#define NAND_4KB_READ_LATENCY_CSB (4000) //ns
#define NAND_READ_LATENCY_LSB (4000)
#define NAND_READ_LATENCY_MSB (4000)
#define NAND_READ_LATENCY_CSB (4000) 
#define NAND_PROG_LATENCY (317500)
#define NAND_ERASE_LATENCY (0)

#define FW_4KB_READ_LATENCY (1)
#define FW_READ_LATENCY (1)
